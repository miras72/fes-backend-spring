...
import pl.tycm.fes.quartz.config.PersistableCronTriggerFactoryBean;
...
public class JobUtil {
	...
	protected static JobDetail createJob(Class<? extends QuartzJobBean> jobClass, boolean isDurable, 
			ApplicationContext context, String jobName, String jobGroup, String keySubjectNameValue, Long keyIdValue){
        ...
        jobDataMap.put("keySubjectName", keySubjectNameValue);
        jobDataMap.put("keyId", keyIdValue);
